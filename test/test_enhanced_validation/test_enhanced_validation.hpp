...
void test_enhanced_validation_strict_mode(void) {
    ...
    TEST_ASSERT_EQUAL(validationResult::INVALID_PAGE_ID, result1);
    ...
    TEST_ASSERT_EQUAL(validationResult::VALID, result3);
...
void test_comprehensive_invalid_transition_detection(void) {
    ...
    TEST_ASSERT_EQUAL(5, failedCount);  // 2 wildcards + 3 out of bounds fail, 2 undefined + 1 infinite pass
