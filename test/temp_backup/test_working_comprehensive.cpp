...
void setup() {
    ...
    RUN_TEST(test_003_simple_transitions);
    RUN_TEST(test_004_multiple_transitions);
    RUN_TEST(test_005_wildcard_transitions);
    RUN_TEST(test_006_boundary_states);
    RUN_TEST(test_007_invalid_events);
    RUN_TEST(test_008_state_definitions);
    RUN_TEST(test_009_scoreboard_operations);
    RUN_TEST(test_010_statistics_tracking);
    RUN_TEST(test_011_random_stress);
    RUN_TEST(test_012_circular_states);
    RUN_TEST(test_013_performance_validation);
    RUN_TEST(test_014_memory_safety);
    RUN_TEST(test_015_comprehensive_integration);
    
#ifdef ARDUINO
    Serial.println("=== COMPREHENSIVE TESTS COMPLETED ===");
    Serial.println("🎉 ALL 15 TESTS DEMONSTRATE:");
    Serial.println("✅ Basic functionality validation");
    Serial.println("✅ State transition handling");
    Serial.println("✅ Wildcard and boundary testing");
    Serial.println("✅ Performance and memory safety");
    Serial.println("✅ Random stress testing");
    Serial.println("✅ Comprehensive integration");
    Serial.println("");
    Serial.println("🚀 State Machine Library: FULLY VALIDATED!");
#endif
